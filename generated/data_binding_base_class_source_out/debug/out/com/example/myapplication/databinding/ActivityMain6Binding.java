...
public final class ActivityMain6Binding implements ViewBinding {
  ...
  private ActivityMain6Binding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
  ...
  public static ActivityMain6Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain6Binding((ConstraintLayout) rootView, imageView, searchButton2,
