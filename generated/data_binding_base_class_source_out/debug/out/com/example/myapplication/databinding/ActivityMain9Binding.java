...
public final class ActivityMain9Binding implements ViewBinding {
  ...
  private ActivityMain9Binding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
  ...
  public static ActivityMain9Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain9Binding((ConstraintLayout) rootView, imageView, searchButton2,
